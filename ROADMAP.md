...
- Define user personas, core use cases (chat, summarization, image/voice tasks), and success metrics.
- Map first-run experience: permissions, model selection, download consent, and offline expectations.
- Sketch Jetpack Compose flows for home, model management, inference sessions, and settings.
